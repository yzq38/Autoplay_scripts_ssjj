...
class AutoBot:
    ...
    def load_all_templates(self):
        ...
        self.load_level_states("haidao11", haidao11_states)
    ...
    def wait_for_template(self, template_name, timeout=50, check_interval=1, exclusive_mode=False):
        """等待指定模板出现在屏幕上"""
    ...
    def main_loop(self):
        ...
        while True:
            ...
            try:
                # 1. 点击关卡编号（使用状态识别）
                if not self.click_level_with_states("haidao11", max_retry=5):
                    print("无法找到关卡选择，跳过本轮")
                    continue
                time.sleep(1)
