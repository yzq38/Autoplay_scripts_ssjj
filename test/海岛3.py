...
class AutoBot:
    ...
    def load_all_templates(self):
        ...
        self.load_level_states("haidao3", haidao3_states)
    ...
    def main_loop(self):
        ...
        while True:
            ...
            try:
                # 1. 点击关卡编号（使用状态识别）
                if not self.click_level_with_states("haidao3", max_retry=5):
                    print("无法找到关卡选择，跳过本轮")
                    continue
                time.sleep(1)
                ...
                if self.check_challenge_count_zero():
                    ...
                    self.click_template("changefuwen_to2")
                    time.sleep(5)
