...
class AutoBot:
    ...
    def game_internal_operations(self):
        ...
        if not kazhu:
            ...
            try:
                ...
                self.move_mouse_win32(4200, 0, duration=1)
                time.sleep(0.5)
                ...
                for i in range(270):
                    if self.find_success(0.8):
                        ...
                        break
                    time.sleep(1)
                    self.move_mouse_win32(800, 0, duration=0.3)
                    if self.find_success(0.8):
                        time.sleep(1)
                        print("等待结算")
                        break
    ...
    def load_all_templates(self):
        ...
        self.load_level_states("diyv2", diyv2_states)
    ...
    def main_loop(self):
        ...
        while True:
            ...
            try:
                # 1. 点击关卡编号（使用状态识别）
                if not self.click_level_with_states("diyv2", max_retry=5):
                    print("无法找到关卡选择，跳过本轮")
                    continue
                time.sleep(1)
