...
class AutoBot:
    ...
    def game_internal_operations(self):
        ...
        if not kazhu:
            ...
            try:
                ...
                time.sleep(8)
                self.keyboard_controller.release('w')
                self.move_mouse_win32(-2850, 0, duration=0.8)
                self.keyboard_controller.press('w')
                time.sleep(6.2)
                self.keyboard_controller.release('w')
                self.keyboard_controller.press('d')
    ...
    def load_all_templates(self):
        ...
        self.load_level_states("haidao1", haidao1_states)
    ...
    def main_loop(self):
        ...
        while True:
            ...
            try:
                # 1. 点击关卡编号（使用状态识别）
                if not self.click_level_with_states("haidao1", max_retry=5):
                    print("无法找到关卡选择，跳过本轮")
                    continue
                time.sleep(1)
